  ...
  return (
    <div id="about">
        <div className='about-first-part'>
            ...
            <h1 className='message'>Hello, my name is Madelyn Torff</h1>
            <p className='description'>Short text with details about you, what you do or your professional career. 

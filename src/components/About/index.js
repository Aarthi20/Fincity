                    ...
                    <div className="about-container">
                        <div className="about">
                            <div className="card-container">
                             ...
                             <h1 className="about-name">Hello, My name is Aarthi M</h1>
                             <p className="sub-heading">I'm currently learning fullstack development with a specialization in ccbp 4.0 technologies.I love with the coding challenges and hands on projects.
                             I have developed Static, Responsive and Dynamic webpages.
                             </p>

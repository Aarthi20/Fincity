  ...
  return (
    <div>
      <div>
        ...
        <label htmlFor="projectName" className='project-name'>Project Name:</label>
        <input
          type="text"
          id="projectName"
          name="projectName"
        ...
        <label htmlFor="projectLink" className='project-link'>Project Link:</label>
        <input
          type="text"
          id="projectLink"
          name="projectLink"
        ...
        <label htmlFor="projectDescription" className='project-desc'>Project Description:</label>
        <textarea
        ...
        <button onClick={handleAddProject} className='add-button'>Add</button>
      </div>
      </div>
      <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="1436" height="112" viewBox="0 0 1436 112" fill="none" className='yellow-vector'>
      ...
      <div className='project-view'>
        ...
        {projects.map((project, index) => (
          <div key={index} className='each-item'>
            ...
            <p >
              Link: <a href={project.projectLink} target="_blank" rel="noopener noreferrer">{project.projectLink}</a>
            </p>
